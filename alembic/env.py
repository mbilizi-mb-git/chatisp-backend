...
# Récupérer l'URL asynchrone depuis les settings
settings = get_settings()
db_url_async = settings.database_url

# Convertir l'URL asynchrone en URL synchrone pour Alembic
# Exemple: postgresql+asyncpg://... -> postgresql://...
db_url_sync = db_url_async.replace("+asyncpg", "")

# Surcharger l'URL dans la configuration d'Alembic
...
def run_migrations_online() -> None:
    # Utilisation d'un moteur synchrone (psycopg2)
